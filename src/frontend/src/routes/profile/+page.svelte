<script lang="ts">
	...
	let userProfile = {
		...
		about: '3rd Year Computer Science Student',
		interests: ['Cooking', 'Water Sports', 'DnB', 'Drama', 'Camping', 'Golf', 'Photography']
	};
</script>
			...
			<div class="card bg-base-100 min-h-1/2 w-full rounded-3xl">
				<div class="card-body bg-secondary rounded-3xl">
					<div class="mb-4 flex items-center justify-between">
						<button class="hover:text-primary ml-auto">
							{@html pencil}
						</button>
					</div>
		...
		<div class="space-y-10">
			...
			<div class="card bg-base-100 shadow-4xl min-h-1/3 w-full rounded-3xl">
				<div class="card-body bg-secondary rounded-3xl">
					...
					<p class="text-user-details">{userProfile.about || 'No bio available.'}</p>
				</div>
			</div>
			<!-- Interests Section -->
			<div class="card bg-base-100 shadow-4xl min-h-1/3 w-full rounded-3xl">
				<div class="card-body bg-secondary rounded-3xl">
					...
					<div class="flex flex-wrap justify-center space-y-2">
						...
						{/each}
						<button class="border-primary text-primary m-1 flex space-x-2 rounded-lg border-2 p-2">
							<p class="text-primary pr-2 text-center text-lg">Add more</p>
