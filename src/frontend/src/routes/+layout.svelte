			...
			<ul>
				<li class="panel-item">
					<a href="/home" class="flex flex-row items-center">
						<svg
							...
							viewBox="0 0 24 24"
							fill={page.url.pathname === '/home' ? 'var(--color-primary)' : 'var(--color-base-content)'}
						>
							<path
						...
						<span
							...
							style="color: {page.url.pathname === '/home'
								? 'var(--color-primary)'
								: 'var(--color-base-content)'}">Hub</span
						>
					</a>
				</li>
				<li class="panel-item">
					<a href="/communities" class="flex flex-row items-center">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 24 24"
							fill={page.url.pathname === '/communities' ? 'var(--color-primary)' : 'var(--color-base-content)'}
						>
							<path
						...
						<span
							...
							style="color: {page.url.pathname === '/communities'
								? 'var(--color-primary)'
								: 'var(--color-base-content)'}">Communities</span
						>
					</a>
				</li>
				<li class="panel-item">
					<a href="/events" class="flex flex-row items-center">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 24 24"
							fill={page.url.pathname === '/events' ? 'var(--color-primary)' : 'var(--color-base-content)'}
						>
							<path
						...
						<span
							...
							style="color: {page.url.pathname === '/events'
								? 'var(--color-primary)'
								: 'var(--color-base-content)'}">Events</span
						>
					</a>
				</li>
				<li class="panel-item">
					<a href="/notifications" class="flex flex-row items-center">
						...
						<span
							...
							style="color: {page.url.pathname === '/notifications'
								? 'var(--color-primary)'
								: 'var(--color-base-content)'}">Notifications</span
						>
					</a>
				</li>
				<li class="panel-item">
					<a href={`/profile`} class="flex flex-row items-center">
						<svg
							xmlns="http://www.w3.org/2000/svg"
							viewBox="0 0 24 24"
							fill={page.url.pathname === `/profile` ? 'var(--color-primary)' : 'var(--color-base-content)'}
						>
							<path
								fill-rule="evenodd"
						...
						<span
							...
							style="color: {page.url.pathname === `/profile`
								? 'var(--color-primary)'
								: 'var(--color-base-content)'}">Profile</span
						>
					</a>
				</li>
				<li class="panel-item">
				...
				<li class="panel-item">
					<button onclick={logout} class="flex flex-row items-center hover:text-primary">
						<svg class="panel-item-svg" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
